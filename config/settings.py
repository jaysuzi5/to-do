...
if DEBUG:
    ...
    EMAIL_USE_TLS = True
    EMAIL_HOST_USER = env('EMAIL_HOST_USER', default='jaysuzi5@gmail.com')
    EMAIL_HOST_PASSWORD = env('EMAIL_HOST_PASSWORD', default='')
    DEFAULT_FROM_EMAIL = env('EMAIL_HOST_USER', default='jaysuzi5@gmail.com')
...
if os.getenv('DJANGO_ENV') == 'production':
    SECURE_SSL_REDIRECT = False  # Cloudflare terminates TLS
